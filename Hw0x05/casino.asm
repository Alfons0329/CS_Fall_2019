...
0000000000400274 <.note.gnu.build-id>:
  ...
  400283:	00 26                	add    BYTE PTR [rsi],ah
  400285:	2e b8 69 73 ea 72    	cs mov eax,0x72ea7369
  40028b:	1e                   	(bad)  
  40028c:	32 75 97             	xor    dh,BYTE PTR [rbp-0x69]
  40028f:	75 9a                	jne    40022b <_init-0x475>
  400291:	8a 57 3b             	mov    dl,BYTE PTR [rdi+0x3b]
  400294:	41 12 4b 34          	adc    cl,BYTE PTR [r11+0x34]
